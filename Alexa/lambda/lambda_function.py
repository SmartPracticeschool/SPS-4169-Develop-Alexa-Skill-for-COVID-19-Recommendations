...
class addDetails(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        url = "https://xp2w35pa64.execute-api.us-east-1.amazonaws.com/guided?names="+str(person_name_value)+"&location="+str(person_location_value)+"&temperature="+str(temparature_value)
        response = requests.get(url)
